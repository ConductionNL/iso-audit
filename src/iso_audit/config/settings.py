...
VELDEN: tuple[Veld, ...] = (
    ...
    Veld("repo.repositories", "AUDIT_REPOS"),
    Veld("repo.github_token", "GITHUB_TOKEN", geheim=True),
    Veld("repo.github_app_id", "GITHUB_APP_ID"),
    Veld("repo.github_app_installation_id", "GITHUB_APP_INSTALLATION_ID"),
    Veld("repo.github_app_private_key", "GITHUB_APP_PRIVATE_KEY", geheim=True),
    Veld("repo.codeberg_token", "CODEBERG_TOKEN", geheim=True),
