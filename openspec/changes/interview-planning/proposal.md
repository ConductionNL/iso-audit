...
**Een voorgesteld interview per ongedekte clausule.** Niet één generieke vragenlijst maar per
clausule: welke eisen open staan, welke `bewijslast` uit de normtekst een mens kan bevestigen, en
welke vragen dat afdekken. De vragen komen uit de norm-catalogus, niet uit modelkennis over hoe
je interviewt.
