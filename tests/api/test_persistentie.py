...
def _nieuw_proces(sessie_dir: Path) -> TestClient:
    """Simuleer een pod-restart: nieuwe app + nieuwe sessie op dezelfde directory."""
    ...
    return TestClient(create_app(session), headers={EMAIL_HEADER: _AUDITOR})
